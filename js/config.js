...
const CONFIG = Object.freeze({
  ...
  sealStates: { movingToDungeon: 'movingToDungeon', waitingAtDungeon: 'waitingAtDungeon', expeditionRunning: 'expeditionRunning', returningFromDungeon: 'returningFromDungeon', questing: 'questing', arrivingFromSea: 'arrivingFromSea', choosingArrivalAction: 'choosingArrivalAction', movingToFacility: 'movingToFacility', usingFacility: 'usingFacility', choosingHuntArea: 'choosingHuntArea', movingToHuntArea: 'movingToHuntArea', hunting: 'hunting', movingToMonster: 'movingToMonster', fighting: 'fighting', returningFromHunt: 'returningFromHunt', choosingPostHuntFacility: 'choosingPostHuntFacility', leavingToSea: 'leavingToSea', idle: 'idle', fallen: 'fallen', downed: 'downed', rescuing: 'rescuing', carryingFallenSeal: 'carryingFallenSeal', beingCarried: 'beingCarried', resting: 'resting', recoveryRest: 'recoveryRest', arriving: 'arriving', movingToHuntExit: 'movingToHuntExit', choosingFacility: 'choosingFacility', leaving: 'leaving' },
  ...
  DOWNED_RECOVERY: { rescueSearchRadiusTiles: 12, recoveryHpRatioToStand: 0.45, carriedRecoveryHpRatioToStand: 0.6, recoveryPerSecondAfterRescue: 2, downedVisualTiltRadians: 1.5708, downedBounceScale: 0.95, downedIcon: '💫', recoveryIcon: '💤' },

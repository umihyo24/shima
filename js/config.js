...
const CONFIG = Object.freeze({
  ...
  tools: [
    ...
    { id: 'inn', label: '🏨 宿屋', name: '宿屋', category: 'relax', kind: 'facility', w: 2, h: 2, width: 2, height: 2, cost: 0, effectText: 'HPが減ったあざらしが休息し、利用料金を支払います。', requiresRoadEntrance: true, levelText: '利用回数で施設レベルが上がり、回復量と収益が伸びます。', notes: '入口が道路に接続している必要があります。木の近くで装飾ボーナスを得ます。' },
